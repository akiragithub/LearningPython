...
class Interface :
    ...
    #    img = Image.open("new_file1.png")
        about_us_img = ImageTk.PhotoImage(file=r"about_us_r.png")
        delete_img = ImageTk.PhotoImage(file=r"delete_r.png")
        create_new_img = ImageTk.PhotoImage(file=r"create_new_r.png")
        save_img = ImageTk.PhotoImage(file=r"save_r.png")
        cancel_img = ImageTk.PhotoImage(file=r"cancel_r.png")
        quit_img = ImageTk.PhotoImage(file=r"exit_r.png")
    ...
    #   Body part
        ...
        search_img = ImageTk.PhotoImage(file=r'search_r.png')
        ...
        self.mlb = treeCtrl.MultiListbox(columns_names_canvas, columns=columns_tuple, selectcmd=self.on_item_selected )
    ...
    def display_result(self, results):
        ...
        for result in results:
            ...
            if status == self.BOOK_AVAILABLE :
                ...
                date_pret = date_pret[0][0].strftime("%d-%m-%Y %H-%M-%S")
